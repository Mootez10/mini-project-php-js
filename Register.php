<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $duplicate = mysqli_query($conn, "SELECT * FROM register WHERE firstname = '$firstname' OR email = '$email' ");
      ...
      elseif($password == $password){
          $query = "INSERT INTO register (firstname, lastname, email, password, usertype) VALUES ('$firstname', '$lastname', '$email', '$password', 'user')";
...
<body>
    <nav class="flex justify-between bg-gray-900 text-white w-full">
        <div class="px-5 xl:px-12 py-6 flex w-full items-center">
          <a class="text-3xl font-bold font-heading" href="home.html">
            3M TECH
          </a>
          <!-- Search Bar -->
                      ...
                      <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" name="firstname" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Mootez">
                                </div>
                            </div>
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" name="lastname" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Aouinti">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="email" name="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="example@example.com">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button id="btn" name="submit" value="login" type="submit" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                            </div>
                        </div>
                    </div>
                      </form>
